...
-->
  ...
  <div class="header">
    ...
    <div class="content_resize">
      <div class="mainbar">
          <div class="search" style="border: 1px solid red;border-top-left-radius: 20px;border-bottom-right-radius: 20px;width: 500px;height: 150px;margin-left: 50px;margin-top: 60px">
